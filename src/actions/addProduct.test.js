...
describe('Given the addProduct action', () => {
  ...
  describe('when the action is called', () => {
    ...
    describe('and name of a product is provided', () => {
      ...
      it('should create a payload with the provided product name', () => {
        expect(action.payload.name).toBe('Product 1');
      });
    });

    describe('and a name of a product is not provided', () => {
      beforeAll(() => {
        name = null;
      });

      it('should create a paylaod without the provided product name', () => {
